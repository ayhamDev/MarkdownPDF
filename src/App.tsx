...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="print:hidden h-14 px-6 bg-white border-b border-slate-200 flex items-center justify-between shrink-0 z-10 w-full relative">
      ...
      <main className="print:hidden flex flex-1 overflow-hidden lg:flex-row flex-col">
        ...
        <aside className="w-full lg:w-64 bg-slate-50 border-b lg:border-b-0 lg:border-r border-slate-200 flex flex-col shrink-0 z-10 custom-scrollbar shadow-sm lg:shadow-none">
        ...
        {/* Live Preview Pane */}
        <section className="flex-1 flex flex-col relative bg-slate-100/80">
